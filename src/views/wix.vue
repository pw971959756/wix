<template>
  <div class="app-container">
    ...
    <el-table :key="tableKey" v-loading="tableListLoading" :data="tableList" @sort-change="tableOrder"
      ...
      <el-table-column prop="wixTitle" label="Title" sortable width="180"></el-table-column>
      <el-table-column prop="wixAuthor" label="Author" sortable width="180"></el-table-column>
      <el-table-column prop="wixTypesetting" label="Editor" sortable width="180"></el-table-column>
      <el-table-column prop="wixPublishing" label="Publisher" sortable width="180"></el-table-column>
      <el-table-column prop="wixReleaseDate" label="Date" sortable width="180"></el-table-column>
      <el-table-column prop="wixSummary" label="Abstract" sortable width="180"></el-table-column>
      <el-table-column prop="lastUpdateDateTime" label="Last Update Date" sortable width="180"></el-table-column>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="Date" prop="wixReleaseDate">
              <el-date-picker v-model="temp.wixReleaseDate" value-format="yyyy-MM-dd" type="date" placeholder="select date"></el-date-picker>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
